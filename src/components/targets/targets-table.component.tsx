              ...
              return (
                <>
                  ...
                  >
                    ...
                    <TableCell>{formatter.format(total.balanceEnd)}</TableCell>
                    <TableCell>{formatter.format(total.cashPerDay)}</TableCell>
                    <TableCell>{formatter.format(total.totalCredit)}</TableCell>
                    <TableCell>{formatter.format(total.totalDebit)}</TableCell>
                    <TableCell>
